...
var app = (function () {
	...
	function create_fragment$3(ctx) {
		var div, h30, t1, p0, t3, h31, t5, p1, t7, p2, t9, p3;
		...
		return {
			c: function create() {
				...
				add_location(p3, file$3, 20, 2, 918);
	...
	function create_fragment$4(ctx) {
		...
		return {
			c: function create() {
				...
				t11 = space();
				p4 = element("p");
				p4.textContent = "I am very dedicated and self motivated in addition to this I strive to perfect every task I take up.";
				t13 = space();
				p5 = element("p");
				...
				add_location(p5, file$4, 52, 4, 1463);
